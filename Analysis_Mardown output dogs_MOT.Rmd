---
title: "R code and Markdown output to accompany Exploring the relationship between dog ownership and car use in the UK based on spatial data "
author: "Ian Philips"
date: "06/08/2021"
...
# This is an R markdown version of the script that I used to run the dogs and car use analysis
...
#postcode districts 
# from https://digimap.edina.ac.uk Code point open polygons
...
An R squared of 0.3109  is achieved when dogs per person is the only 
...
Figure 2 Relationship between dog ownership and rural areas (R = 0.63 Spearman)
...
####  The extended model (D and E ) used in the paper 
...
Without dogs per pserson as a predictor
...
This is the end of the analysis used in the paper.  
